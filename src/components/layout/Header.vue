            ...
            <header class="z-20 w-full xl:px-0 px-2">
                <div class="container mx-auto flex flex-wrap mt-8 mb-8 ">
                    <div class="flex sm:w-1/2 flex">
                        ...
                        <a href="/" class="text-2xl text-white ml-1 font-bold text-blue-800">Recursos Gratis</a>
                    </div>
                </div>
            </header>
            <section class="w-full">
                <div class="container mx-auto flex flex-row sm:items-center xl:pb-16 xl:px-0 px-4">
                    <div class="w-1/2 text-white flex flex-col">
                        <h1 class="sm:text-5xl text-xl font-weight-bolder sm:mb-4 text-blue-800">Recursos gratuitos para aprender a programar
                        </h1>
                        <h2 class="sm:text-2xl text-base mb-2 text-blue-800">Inspirado en el tweet de <a href="https://twitter.com/malerey_/status/1051106925587456003" target="_blank" title="">@_malerey</a>.</h2>
                        <p class="text-xs sm:text-base text-blue-800">Website con el fin de organizar los recursos compartidos vía Twitter en el siguiente 
                        <a href="https://twitter.com/malerey_/status/1051106925587456003" target="_blank" title="">hilo (Click)</a>.</p>
                    </div>
                    <div class="w-1/2 xl:pt-8 xl:items-center flex justify-end">
                        <img class="xl:w-5/5" src="@/assets/images/learn.svg" alt="Mobile phone"/>
                    </div>
                </div>
            </section>
        </div>
